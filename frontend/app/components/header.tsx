    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg team-container p-4">
        ...
        {teamMembers.map((member) => (
          <div key={member.id} className="p-4 border-b dark:border-gray-700 team-member flex items-center gap-4 hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300 ease-in-out rounded-lg">
            <Image
